...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
         ...
         * Ingredients
         */
        Ingredient ingredient1 = new Ingredient("ripe avocados", new BigDecimal(2), savedRecipe1);
        Ingredient ingredient2 = new Ingredient("Kosher salt", new BigDecimal("0.5"), teaspoonUom, savedRecipe1);
        Ingredient ingredient3 = new Ingredient("fresh lime juice or lemon juice", new BigDecimal(1), tableSpoonUom, savedRecipe1);
        Ingredient ingredient4 = new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonUom, savedRecipe1);
        Ingredient ingredient5 = new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal("1.5"), savedRecipe1);
        Ingredient ingredient6 = new Ingredient("cilantro (leaves and tender stems), finally chopped", new BigDecimal("1.5"), savedRecipe1);
        Ingredient ingredient7 = new Ingredient("freshly grated black pepper", new BigDecimal(1), dashUom, savedRecipe1);
        Ingredient ingredient8 = new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal("0.5"), savedRecipe1);

        savedRecipe1.addIngredient(ingredient1);
        savedRecipe1.addIngredient(ingredient2);
        savedRecipe1.addIngredient(ingredient3);
        savedRecipe1.addIngredient(ingredient4);
        savedRecipe1.addIngredient(ingredient5);
        savedRecipe1.addIngredient(ingredient6);
        savedRecipe1.addIngredient(ingredient7);
        ...
        Ingredient ingredient9 = new Ingredient("ancho chili powder", new BigDecimal(2), tableSpoonUom, savedRecipe2);
        Ingredient ingredient10 = new Ingredient("dried oregano", new BigDecimal(1), teaspoonUom, savedRecipe2);
        Ingredient ingredient11 = new Ingredient("dried cumin", new BigDecimal(1), teaspoonUom, savedRecipe2);
        Ingredient ingredient12 = new Ingredient("sugar", new BigDecimal(1), teaspoonUom, savedRecipe2);
        Ingredient ingredient13 = new Ingredient("salt", new BigDecimal("1.5"), teaspoonUom, savedRecipe2);
        Ingredient ingredient14 = new Ingredient("garlic, finely chopped", new BigDecimal(1), cloveUom, savedRecipe2);
        Ingredient ingredient15 = new Ingredient("finely grated orange zest", new BigDecimal(1), tableSpoonUom, savedRecipe2);
        Ingredient ingredient16 = new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tableSpoonUom, savedRecipe2);
        Ingredient ingredient17 = new Ingredient("olive oil", new BigDecimal(2), tableSpoonUom, savedRecipe2);
        Ingredient ingredient18 = new Ingredient("skinless, boneless chicken thighs", new BigDecimal(5), savedRecipe2);
        Ingredient ingredient19 = new Ingredient("small corn tortillas", new BigDecimal(8), savedRecipe2);
        Ingredient ingredient20 = new Ingredient("packed baby arugula", new BigDecimal(8), savedRecipe2);
        Ingredient ingredient21 = new Ingredient("medium ripe avocados, sliced", new BigDecimal(2), savedRecipe2);
        Ingredient ingredient22 = new Ingredient("radishes, thinly sliced", new BigDecimal(4), savedRecipe2);
        Ingredient ingredient23 = new Ingredient("radishes, thinly slicedpint cherry tomatoes, halved", new BigDecimal("1.5"), savedRecipe2);
        Ingredient ingredient24 = new Ingredient("red onion, thinly sliced", new BigDecimal("0.25"), savedRecipe2);
        Ingredient ingredient25 = new Ingredient("chopped cilantro", new BigDecimal("0.25"), savedRecipe2);
        Ingredient ingredient26 = new Ingredient("sour cream thinned", new BigDecimal("0.5"), cupUom, savedRecipe2);
        Ingredient ingredient27 = new Ingredient("cup milk", new BigDecimal("0.25"), cupUom, savedRecipe2);
        Ingredient ingredient28 = new Ingredient("lime, cut into wedges", new BigDecimal(1), savedRecipe2);

        savedRecipe2.addIngredient(ingredient9);
        savedRecipe2.addIngredient(ingredient10);
        savedRecipe2.addIngredient(ingredient11);
        savedRecipe2.addIngredient(ingredient12);
        savedRecipe2.addIngredient(ingredient13);
        savedRecipe2.addIngredient(ingredient14);
        savedRecipe2.addIngredient(ingredient15);
        savedRecipe2.addIngredient(ingredient16);
        savedRecipe2.addIngredient(ingredient17);
        savedRecipe2.addIngredient(ingredient18);
        savedRecipe2.addIngredient(ingredient19);
        savedRecipe2.addIngredient(ingredient20);
        savedRecipe2.addIngredient(ingredient21);
        savedRecipe2.addIngredient(ingredient22);
        savedRecipe2.addIngredient(ingredient23);
        savedRecipe2.addIngredient(ingredient24);
        savedRecipe2.addIngredient(ingredient25);
        savedRecipe2.addIngredient(ingredient26);
        savedRecipe2.addIngredient(ingredient27);
